            ...
            <div className={css.right}>
                ...
                <div className={css.quantity}>
                    ...
                    <div className={css.counter}>
                        <Image src={LeftArrow} onClick={()=>handleQuan("dec")} alt="" height={20} width={20} objectFit="contain" />
                        <span>{Quantity}</span>
                        <Image src={RightArrow} onClick={()=>handleQuan("inc")} alt="" height={20} width={20} objectFit="contain"/>
                    </div>
                </div>
